...
<body background="mat.png">
	<div class="container">
		<div class="row justify-content-center" style="background: rgba(176, 105, 180, 0.2); border-radius: 20px; border: 2px solid white">
			<div class="col-md-12">
		...
		<div class="row justify-content-center" style="background: rgba(76, 175, 80, 0.1); border-radius: 20px; border: 2px solid orange">
			<div class="col-md-12">
